...
function initMeScroll(mescrollId, options) {
    ...
    htmlContent += '<img class="downwarp-progress" src="../image/option/mescroll-progress.png"/>';
    htmlContent += '<img class="downwarp-slogan" src="../image/option/mescroll-slogan.png"/>';

    //上拉加载中的布局
    var htmlLoading = '<img class="upwarp-progress mescroll-rotate" src="../image/option/mescroll-progress.png"/>';
    htmlLoading += '<img class="upwarp-slogan" src="../image/option/mescroll-slogan.png"/>';
    //无数据的布局
    var htmlNodata = '<img class="upwarp-nodata" src="../image/option/mescroll-nodata.png"/>';
