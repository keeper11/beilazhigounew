...
(function(name, definition) {
    ...
    MeScroll.prototype.extendUpScroll = function(optUp) {
        ...
        MeScroll.extend(optUp, {
            ...
            offset: 80, // 列表滚动到距离底部小于100px,即可触发上拉加载的回调
            toTop: {
                // 回到顶部按钮,需配置src才显示
                warpId: null, // 父布局的id; 默认添加在body中
                src: "../../image/option/mescroll-totop.png", // 图片路径,默认null;
            ...
            lazyLoad: {
                ...
                delay: 10, // 列表滚动的过程中每500ms检查一次图片是否在可视区域,如果在可视区域则加载图片
                offset: 150 // 超出可视区域200px的图片仍可触发懒加载,目的是提前加载部分图片
            }
        })
    }
    ...
    MeScroll.prototype.endSuccess = function(dataSize, hasNext, systime) {
        ...
        if (me.optUp.use) {
            ...
            // 懒加载
            me.optUp.lazyLoad.use && me.lazyLoad(5);
        }
    }
